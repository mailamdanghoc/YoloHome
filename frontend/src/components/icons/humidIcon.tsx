const HumidIcon = ({ color, className }: { color: string, className: string }) => {
    return (
        <svg viewBox="0 0 1024 1024" className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" fill={color}>
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path d="M363.7 468.8c-27.9 59.7-46.8 115.7-46.8 158.4 0 164.6 133.4 298 298 298s298-133.4 298-298c0-12.8-1.9-26.9-5.5-41.9-327.2 33.9-284.9-194.9-543.7-116.5z" fill={color}/>

                <path d="M333.6 567.6c-38.2 239.9 123 357.7 287.3 357.7 92.8 0 144.9-12.1 199.6-78.6-261.5 20.7-428.7-99.2-486.9-279.1z" fill={color}/>
